...
@Entity
// Significa que esta clase va a mapear la tabla secciones de la base de datos
...
public class Secciones implements Serializable{
    ...
    // @Column (name="idSecciones") significa que la variable va a ser referencia a la columna
    // idSecciones de la base de datos
